            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        ...
                        <button className="w-full sm:w-52 h-14 bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-full font-bold text-lg hover:shadow-lg hover:opacity-90 transition-all">
                            Explore Products
                        </button>

                        
                        <button className="group relative w-full sm:w-52 h-14 p-[1.5px] rounded-full bg-linear-to-r from-indigo-500 to-purple-500">
                            <div className="flex items-center justify-center w-full h-full bg-white rounded-full group-hover:bg-transparent transition-all">
                                <span className="flex items-center gap-2 font-bold bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent group-hover:text-white transition-colors">
                ...
                <div className="flex-1 order-1 lg:order-2 w-full max-w-125 lg:max-w-none">
